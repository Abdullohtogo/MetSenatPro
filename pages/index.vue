  ...
  <section class="bg-gray-100 py-[24px]">
    <div class="mx-[120px] flex justify-between">
      ...
      <div class="flex gap-5">
        <div class="">
          <label for="search" class="absolute translate-x-2 translate-y-2.5"><img src="/icons/search.svg"
                                                                                  alt=""/></label>
          <Input type="search" placeholder="Izlash" class="px-8" name="search" id="search" v-model="searchQuery"
                 @input="data"/>
        </div>
        <div>
          <button class="bg-gray-200 gap-1.5 flex rounded-md" @click="openModal">
            <img src="/icons/filter.svg" alt="" class="mt-[3px] py-[11px] pl-[32px]"/><span
              class="text-blue text-[16px] font-semibold sf pr-[32px] py-[10px]">filter</span>
          </button>
        </div>
      </div>
    </div>
